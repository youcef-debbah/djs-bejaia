...
public class DefaultContractBeanImpl implements ContractBean {
    ...
    @Override
    public PropertyEntity addProperty(Integer contractTemplateID, String rawPropertyName, InputType newPropertyType) throws IntegrityException {
        Check.argNotNull(contractTemplateID, rawPropertyName, newPropertyType);
        String newPropertyName = DatabaseEntity.normalizeIdentifier(rawPropertyName);
    ...
    @Override
    public ActivityEntity addActivity(Integer contractTemplateID, String rawActivityName) throws IntegrityException {
        Check.argNotNull(contractTemplateID, rawActivityName);
        String newActivityName = DatabaseEntity.normalizeIdentifier(rawActivityName);
    ...
    private void checkTemplateName(String newTemplateName) throws IntegrityException {
        checkDuplicatedTemplateName(DatabaseEntity.normalizeIdentifier(newTemplateName));
    }
